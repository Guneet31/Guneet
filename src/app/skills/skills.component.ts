...
export class SkillsComponent implements OnInit {
  skillsArray = ["Swift ⎨🕊⎬", "SwiftUI 🔥📱", "XCode 💻", "Angular ⎨🅰️⎬", "TypeScript⎨✝️⎬", "JavaScript⎨🉑⎬", "C++ ⎨🔱⎬", "Unreal Engine(Basics Designing)","MySQL 📀", "Blockchain", "Web3.0","Firebase 💿","NodeJS ⎨🚊⎬", "AdobeXD 🎨","Team Work 👩🏼‍💻🧑🏻‍💻","Time Management ⏱"]
